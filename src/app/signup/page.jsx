...
export default function SignUp() {
    ...
    return (
        <>
            <Header />
            <main>
                <section className=" login-page relative lg:pt-25 pt-40">
                <div className="absolute inset-0 bg-black opacity-60 "></div>
                    <div className="container">
                        <div className="relative z-10 flex flex-col items-center justify-center px-6 py-8 mx-auto  pt-20 pb-10 max-w-screen-xl ">
