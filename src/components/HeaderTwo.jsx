  ...
  return (
    <>
      <header className="w-full z-50">
        ...
        <nav
          className={`w-full z-20 transition-all navMain duration-300 ${
          ...
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 py-1">
            <Link href="/" passHref legacyBehavior>
              <a className="flex items-center space-x-3 rtl:space-x-reverse">
                <Image className="logo bg-blue-800 rounded-full" src={logo} alt="Logo" />
              </a>
            </Link>
            ...
            <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
              <Image className="logo" src={anniversarylogo} alt="Anniversary Logo" />
            </div>
                  ...
                  >
                    ...
                    {item.name === "Tour" && submenuOpen && (
                      <ul className="absolute z-10 left-0 top-full bg-white shadow-md rounded-md py-2 w-48">
                        {[ 
                          { name: "Africa tours", link: "/africatours" },
                          { name: "Asia tours", link: " " },
                          { name: "Europe tours", link: " " },
                          { name: "Middle East tours", link: " " },
                          { name: "America tours", link: " " },
